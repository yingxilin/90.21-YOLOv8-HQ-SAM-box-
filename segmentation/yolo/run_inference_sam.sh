...
SAM_CKPT_PATH="D:/search/fungi/24/FungiTastic/ckpts/sam_vit_h_4b8939.pth"

# 数据路径
IMAGES_ROOT="D:/search/fungi/24/FungiTastic/FungiTastic-Mini/test/300p"
OUT_MASKS="D:/search/fungi/24/data/FungiTastic/masks_yolo_sam"

# 推理参数
SAM_TYPE="vit_h"  # 标准SAM
CONF=0.35
IOU=0.6
MIN_AREA_RATIO=0.001
DEVICE="cuda"

echo "Starting YOLO+标准SAM inference (ablation study)..."
